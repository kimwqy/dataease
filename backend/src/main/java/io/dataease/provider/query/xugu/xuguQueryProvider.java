package io.dataease.provider.query.xugu;
...
import io.dataease.plugins.common.constants.datasource.XuGuConstants;
 ...
 */
@Service("xuguQueryProvider")
public class xuguQueryProvider extends QueryProvider {
    @Resource
    ...
    public String createQuerySQL(String table, List<DatasetTableField> fields, boolean isGroup, Datasource ds, List<ChartFieldCustomFilterDTO> fieldCustomFilter, List<DataSetRowPermissionsTreeDTO> rowPermissionsTree, List<DeSortField> sortFields) {
        SQLObj tableObj = SQLObj.builder()
                .tableName((table.startsWith("(") && table.endsWith(")")) ? table : String.format(XuGuConstants.KEYWORD_TABLE, table))
        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            for (int i = 0; i < fields.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(f.getExtField()) && f.getExtField() == 2) {
                    ...
                    originField = f.getOriginName();
                } else if (ObjectUtils.isNotEmpty(f.getExtField()) && f.getExtField() == 1) {
                    //originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getOriginName());
                    originField = f.getOriginName();
                } else {
                    //originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getOriginName());
                    originField = f.getOriginName();
                ...
                if (f.getDeExtractType() == 1) {
                    if (f.getDeType() == 2 || f.getDeType() == 3) {
                        fieldName = String.format(XuGuConstants.UNIX_TIMESTAMP, originField) + "*1000";
                    } else {
                        if (f.getType().equalsIgnoreCase("YEAR")) {
                            //fieldName = String.format(XuGuConstants.DATE_FORMAT, "CONCAT(" + originField + ",'-01-01')", XuGuConstants.DEFAULT_DATE_FORMAT);
                            fieldName = originField;
                        } else if (f.getType().equalsIgnoreCase("DATE")) {
                            //fieldName = String.format(XuGuConstants.DATE_FORMAT_DATE, originField, XuGuConstants.DEFAULT_DATE_FORMAT_DATE);
                            fieldName = originField;
                        } else if (f.getType().equalsIgnoreCase("TIME")) {
                            //fieldName = String.format(XuGuConstants.DATE_FORMAT_TIME, originField, XuGuConstants.DEFAULT_DATE_FORMAT_TIME);
                            fieldName = originField;
                        } else {
                            //fieldName = String.format(XuGuConstants.DATE_FORMAT, originField, XuGuConstants.DEFAULT_DATE_FORMAT);
                            fieldName = originField;
                        }
                    }
                } else if (f.getDeExtractType() == 0) {
                    if (f.getDeType() == 2) {
                        //fieldName = String.format(XuGuConstants.CAST, originField, XuGuConstants.DEFAULT_INT_FORMAT);
                        fieldName = originField;
                    } else if (f.getDeType() == 3) {
                        //fieldName = String.format(XuGuConstants.CAST, originField, XuGuConstants.DEFAULT_FLOAT_FORMAT);
                        fieldName = originField;
                    } else if (f.getDeType() == 1) {
                        //fieldName = String.format(XuGuConstants.TO_DATE, originField, XuGuConstants.DEFAULT_DATE_FORMAT);
                        fieldName = originField;
                    } else {
                        fieldName = originField;
                    }
                    ...
                    if (f.getDeType() == 1) {
//                        String cast = String.format(XuGuConstants.CAST, originField, XuGuConstants.DEFAULT_INT_FORMAT) + "/1000";
//                        fieldName = String.format(XuGuConstants.FROM_UNIXTIME, cast, XuGuConstants.DEFAULT_DATE_FORMAT);
                        fieldName = originField;
    ...
    private SQLObj buildSortField(DeSortField f, SQLObj tableObj, int i) {
        ...
        if (ObjectUtils.isNotEmpty(f.getExtField()) && f.getExtField() == 2) {
            ...
            originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getDataeaseName());
        } else {
            originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getDataeaseName());
        }
        String fieldAlias = String.format(SQLConstants.FIELD_ALIAS_X_PREFIX, i);
    ...
    public void setSchema(SQLObj tableObj, Datasource ds) {
        if (ds != null && !tableObj.getTableName().startsWith("(") && !tableObj.getTableName().endsWith(")")) {
            ...
            schema = String.format(XuGuConstants.KEYWORD_TABLE, schema);
    ...
    public String getSQL(String table, List<ChartViewFieldDTO> xAxis, List<ChartViewFieldDTO> yAxis, List<ChartFieldCustomFilterDTO> fieldCustomFilter, List<DataSetRowPermissionsTreeDTO> rowPermissionsTree, List<ChartExtFilterRequest> extFilterRequestList, Datasource ds, ChartViewWithBLOBs view) {
        ...
        if (CollectionUtils.isNotEmpty(xAxis)) {
            for (int i = 0; i < xAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(x.getExtField()) && x.getExtField() == 2) {
                    ...
                    originField = x.getOriginName();
                } else if (ObjectUtils.isNotEmpty(x.getExtField()) && x.getExtField() == 1) {
                    //originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getOriginName());
                    originField = x.getOriginName();
                } else {
                    //originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getOriginName());
                    originField = x.getOriginName();
        ...
        if (CollectionUtils.isNotEmpty(yAxis)) {
            for (int i = 0; i < yAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(y.getExtField()) && y.getExtField() == 2) {
                    ...
                    originField = y.getOriginName();
                } else if (ObjectUtils.isNotEmpty(y.getExtField()) && y.getExtField() == 1) {
                    //originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), y.getOriginName());
                    originField = y.getOriginName();
                } else {
                    //originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), y.getOriginName());
                    originField = y.getOriginName();
        ...
        SQLObj tableSQL = SQLObj.builder().tableName(String.format(XuGuConstants.BRACKETS, sql)).tableAlias(String.format(TABLE_ALIAS_PREFIX, 1)).build();
    ...
    public String getSQLTableInfo(String table, List<ChartViewFieldDTO> xAxis, List<ChartFieldCustomFilterDTO> fieldCustomFilter, List<DataSetRowPermissionsTreeDTO> rowPermissionsTree, List<ChartExtFilterRequest> extFilterRequestList, Datasource ds, ChartViewWithBLOBs view) {
            ...
            for (int i = 0; i < xAxis.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(x.getExtField()) && x.getExtField() == 2) {
                    ...
                    if (x.getDeType() == 2 || x.getDeType() == 3) {
                        originField = String.format(XuGuConstants.CAST, String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getOriginName()), XuGuConstants.DEFAULT_FLOAT_FORMAT);
                    } else {
                        originField = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), x.getOriginName());
                    }
                }
        ...
        SQLObj tableSQL = SQLObj.builder()
                .tableName(String.format(XuGuConstants.BRACKETS, sql))
    ...
    public String transTreeItem(SQLObj tableObj, DatasetRowPermissionsTreeItem item) {
        ...
        if (ObjectUtils.isNotEmpty(field.getExtField()) && field.getExtField() == 2) {
            ...
            originName = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getOriginName());
        } else {
            originName = String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getOriginName());
        }
        ...
        if (field.getDeType() == 1) {
            if (field.getDeExtractType() == 0 || field.getDeExtractType() == 5 || field.getDeExtractType() == 1) {
                //whereName = String.format(XuGuConstants.TO_DATE, originName, XuGuConstants.DEFAULT_DATE_FORMAT);
                whereName = originName;
            }
            if (field.getDeExtractType() == 2 || field.getDeExtractType() == 3 || field.getDeExtractType() == 4) {
//                String cast = String.format(XuGuConstants.CAST, originName, XuGuConstants.DEFAULT_INT_FORMAT) + "/1000";
//                whereName = String.format(XuGuConstants.FROM_UNIXTIME, cast, XuGuConstants.DEFAULT_DATE_FORMAT);
                whereName = originName +"/1000";

            }
        } else if (field.getDeType() == 2 || field.getDeType() == 3) {
            if (field.getDeExtractType() == 0 || field.getDeExtractType() == 5) {
                //whereName = String.format(XuGuConstants.CAST, originName, XuGuConstants.DEFAULT_FLOAT_FORMAT);
                whereName = originName;

            }
            if (field.getDeExtractType() == 1) {
                whereName = String.format(XuGuConstants.UNIX_TIMESTAMP, originName) + "*1000";
            }
            if (field.getDeExtractType() == 2 || field.getDeExtractType() == 3 || field.getDeExtractType() == 4) {
                whereName = originName;
            }
        } else if (field.getDeType() == 0 && field.getDeExtractType() == 0) {
            //whereName = String.format(XuGuConstants.CAST, originName, XuGuConstants.CHAR);
            whereName = originName;
        ...
        if (StringUtils.equalsIgnoreCase(item.getFilterType(), "enum")) {
            ...
            if (StringUtils.equalsIgnoreCase(item.getTerm(), "null")) {
                ...
                whereValue = String.format(XuGuConstants.WHERE_VALUE_VALUE, value);
            }
    ...
    public String convertTableToSql(String tableName, Datasource ds) {
        return createSQLPreview("SELECT * FROM " + String.format(XuGuConstants.KEYWORD_TABLE, tableName), null);
    }
        ...
        for (ChartExtFilterRequest request : requestList) {
            ...
            if (StringUtils.containsIgnoreCase(request.getOperator(), "in")) {
                ...
                if (request.getDatasetTableField().getDeType() == 1) {
                    ...
                    whereValue = String.format(XuGuConstants.WHERE_BETWEEN, startTime, endTime);
                } else {
                    whereValue = String.format(XuGuConstants.WHERE_BETWEEN, value.get(0), value.get(1));
                }
            } else {
                // doris field type test
                /*if (field.getDeExtractType() == 2 || field.getDeExtractType() == 3 || field.getDeExtractType() == 4) {
                ...
                whereValue = String.format(XuGuConstants.WHERE_VALUE_VALUE, value.get(0));
            }
            list.add(SQLObj.builder()
                    .whereField(whereName)
                    .whereTermAndValue(whereTerm + whereValue)
    ...
    private String transDateFormat(String dateStyle, String datePattern) {
        ...
        if (StringUtils.isEmpty(dateStyle)) {
            return XuGuConstants.DEFAULT_DATE_FORMAT;
        }
    ...
    private SQLObj getXFields(ChartViewFieldDTO x, String originField, String fieldAlias) {
        ...
        if (x.getDeExtractType() == 1) {
            if (x.getDeType() == 2 || x.getDeType() == 3) {
                fieldName = String.format(XuGuConstants.UNIX_TIMESTAMP, originField) + "*1000";
                fieldName = originField+"*1000";
            } else if (x.getDeType() == 1) {
                //String format = transDateFormat(x.getDateStyle(), x.getDatePattern());
                //fieldName = String.format(XuGuConstants.DATE_FORMAT, originField, format);
                fieldName = originField;
            } else {
                fieldName = originField;
            }
...
//                    String cast = String.format(XuGuConstants.CAST, originField, XuGuConstants.DEFAULT_INT_FORMAT) + "/1000";
//                    String from_unixtime = String.format(XuGuConstants.FROM_UNIXTIME, cast, XuGuConstants.DEFAULT_DATE_FORMAT);
//                    fieldName = String.format(XuGuConstants.DATE_FORMAT, from_unixtime, format);
                    fieldName = originField;

                }
            } else if (x.getDeType() == 0 && x.getDeExtractType() == 0) {
                //fieldName = String.format(XuGuConstants.CAST, originField, XuGuConstants.CHAR);
                fieldName = originField;

            } else {
                if (x.getDeType().equals(DeTypeConstants.DE_INT)) {
//                    fieldName = String.format(XuGuConstants.CAST, originField, XuGuConstants.DEFAULT_INT_FORMAT);
                    fieldName = originField;

                } else if (x.getDeType().equals(DeTypeConstants.DE_FLOAT)) {
                    //fieldName = String.format(XuGuConstants.CAST, originField, XuGuConstants.DEFAULT_FLOAT_FORMAT);
                    fieldName = originField;
        ...
        if (CollectionUtils.isNotEmpty(x.getFilter()) && x.getFilter().size() > 0) {
            x.getFilter().forEach(f -> {
                ...
                if (StringUtils.equalsIgnoreCase(f.getTerm(), "null")) {
                    ...
                    whereValue = String.format(XuGuConstants.WHERE_VALUE_VALUE, f.getValue());
                }
                list.add(SQLObj.builder()
                        .whereField(whereName)
    ...
    private SQLObj getYFields(ChartViewFieldDTO y, String originField, String fieldAlias) {
        ...
        if (StringUtils.equalsIgnoreCase(y.getOriginName(), "*")) {
            fieldName = XuGuConstants.AGG_COUNT;
        } else if (SQLConstants.DIMENSION_TYPE.contains(y.getDeType())) {
            if (StringUtils.equalsIgnoreCase(y.getSummary(), "count_distinct")) {
                fieldName = String.format(XuGuConstants.AGG_FIELD, "COUNT", "DISTINCT " + originField);
            } else {
                fieldName = String.format(XuGuConstants.AGG_FIELD, y.getSummary(), originField);
            }
        } else {
            if (StringUtils.equalsIgnoreCase(y.getSummary(), "avg") || StringUtils.containsIgnoreCase(y.getSummary(), "pop")) {
                String cast = String.format(XuGuConstants.CAST, originField, y.getDeType() == 2 ? XuGuConstants.DEFAULT_INT_FORMAT : XuGuConstants.DEFAULT_FLOAT_FORMAT);
                String agg = String.format(XuGuConstants.AGG_FIELD, y.getSummary(), cast);
                String cast1 = String.format(XuGuConstants.CAST, agg, XuGuConstants.DEFAULT_FLOAT_FORMAT);
                fieldName = String.format(XuGuConstants.ROUND, cast1, "8");
            } else {
                String cast = String.format(XuGuConstants.CAST, originField, y.getDeType() == 2 ? XuGuConstants.DEFAULT_INT_FORMAT : XuGuConstants.DEFAULT_FLOAT_FORMAT);
                if (StringUtils.equalsIgnoreCase(y.getSummary(), "count_distinct")) {
                    fieldName = String.format(XuGuConstants.AGG_FIELD, "COUNT", "DISTINCT " + cast);
                } else {
                    fieldName = String.format(XuGuConstants.AGG_FIELD, y.getSummary(), cast);
                }
            }
        }
        return SQLObj.builder()
    ...
    private String calcFieldRegex(String originField, SQLObj tableObj) {
        ...
        for (DatasetTableField ele : calcFields) {
            originField = originField.replaceAll("\\[" + ele.getId() + "]",
                    String.format(XuGuConstants.KEYWORD_FIX, tableObj.getTableAlias(), ele.getOriginName()));
        }
        return originField;
    }
